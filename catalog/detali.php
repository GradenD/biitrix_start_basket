<?
  ...
  $rezultFilter = array("CODE" => $poslelement, "IBLOCK_ID" => $IBLOCK_ID, "ACTIVE" => "Y");
              ...
              <div class="single-product-thumb">
                <div class="zoom zoom-hover">
                  <div class="thumb-item">
                    <a class="lightbox-image" data-fancybox="gallery" href="<?=$img?>">
          ...
          <div class="col-lg-6">
            <div class="single-product-info">
              ...
              <div class="product-ratting">
                ...
                <div class="ratting-caption">1 Просмотр</div>
              </div>
              <div class="prices">
                                              <?
                                                if($old_price != ""){
              ...
              <div class="quick-product-action">
                ...
                <div class="action-top action-basket">
                  <?
                    if($_SESSION['order'][$arFields["ID"]] != ""){
                      ?>
                        <a href="/basket/" data-id="<?=$arFields["ID"]?>" class="btn btn-black"><i class="fa fa-opencart"></i>В корзине</a>
                      <?
                    }else{
                      ?>
                        <div class="pro-qty">
                          <input class="quantity" type="text" id="quantity" title="Quantity" value="1" />
                        </div>
                        <button data-id="<?=$arFields["ID"]?>" class="btn btn-black btn-action-basket"><i class="fa fa-opencart"></i>В корзину</button>
                      <?
                    }
                  ?>
                ...
                <div class="action-bottom">
                  <a class="btn-theme calc-ipoteck" data-id="<?=$arFields["ID"]?>" href="javascript:void(0);">Рассчитать ипотеку</a>
                </div>
              </div>
                  ...
                  <div class="product-comment">
                    <form action="#">
                      <div class="product-comment-content">
                        <img src="<?=SITE_TEMPLATE_PATH?>/assets/img/shop/comment.png" alt="Image-HasTech">
